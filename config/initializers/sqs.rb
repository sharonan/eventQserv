...
#    #client = $sqs_new.client
#    client = AWS::SQS::Client.new( :access_key_id => 'AKIAJ5H7P7PQYCDLJKYQ',
#                                   :secret_access_key => '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',
#                                   :region => 'us-west-2')
#    if (!queue_name.nil? && !publisher_arn.nil? && !client.nil?)
#      queue = $sqs.queues.create("#{$env}_#{queue_name}")
...
#                    ]
#      }
#      permissions = [{ :queue_url => queue.url ,
#                       :label  =>   publisher_arn          ,
...
#      client.add_permission(permissions)
#
#    end
#  end
#end