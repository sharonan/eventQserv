...
#
#
#    $batch_write = AWS::DynamoDB::BatchWrite.new(:access_key_id => 'AKIAJ5H7P7PQYCDLJKYQ',
#                                                 :secret_access_key => '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',
#                                                 :region => 'us-west-2')
#    $batch_get = AWS::DynamoDB::BatchGet.new(:access_key_id => 'AKIAJ5H7P7PQYCDLJKYQ',
#                                             :secret_access_key => '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',
#                                             :region => 'us-west-2')
#  #end
#
...
#                               #puts "TABLE STATUS #{table.status}"
...
#    #batch = AWS::DynamoDB::BatchWrite.new(:access_key_id => 'AKIAJ5H7P7PQYCDLJKYQ',
#    #                                      :secret_access_key => '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',
#    #                                      :region => 'us-west-2')
...
#    end
#    return arr
#    ##$batch_get.initialize
#    #items.each do|item|
#    #  picked_items = $batch_get.items(attributes,item)
#    #  puts "picked_items #{picked_items}"
#    #  return picked_items
#    #  end
#
#    #return picked_items
...
#          #puts "??? #{item_to_update.attributes[attribute_to_update].nil?}"
#          #success = !item_to_update.attributes[attribute_to_update].nil?
#          #if (success)
...
#  end
#
#  def self.update_record_attributes(table_name,  attributes_updated_values_hash,hash_key, hash_key_value)
#
#    table = $dynamo_db.tables["#{$env}_#{table_name}"]
#    table.hash_key = hash_key
#    #item = table.items[hash_key_value]
